    ...
    <div>
    	@if (Auth::check())
	    	...
	    	<p>This website application will help you navigate through all your everyday task.
	    		<br>It displays all your current and ongoing task, and you can constantly add new
	    		<br>tasks everytime.</p>
	    @else 
	    	<h1>Welcome</h1>

	    	<p>This website application helps the user navigate through all the user's task.
	    		<br>It displays all the user's current and ongoing task, and the user can 
